...
import { Loader2, Mic, MoreHorizontal, Pause, Play, Trash2 } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function VoiceCard({ voice }: VoiceCardProps) {
  ...
  return (
    <div className="flex items-center gap-1 overflow-hidden rounded-xl border pr-3 lg:pr-3">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1.5 lg:gap-3">
        <div className="flex items-center gap-1.5 line-clamp-1 text-sm font-medium tracking-tight">
          ...
          <span>{VOICE_CATEGORY_LABELS[voice.category]}</span>
        </div>
